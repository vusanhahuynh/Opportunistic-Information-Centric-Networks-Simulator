...
public class SocialAndReplacement extends ActiveRouter {
    ...
    public SocialAndReplacement(Settings s) {
        super(s);
     ...
     */
    public SocialAndReplacement(SocialAndReplacement r) {
        super(r);
        fstHopEncounters = new HashMap<DTNHost, EncounterInfo>();
        secHopEncounters = new HashMap<DTNHost, Map<DTNHost, EncounterInfo>>();
    ...
    public MessageRouter replicate() {
        return new SocialAndReplacement(this);
    }
    ...
    public void changedConnection(Connection con) {
        ...
        if (con.isUp()) {
            ...
            if (con.isInitiator(getHost())) {
                ...
                SocialAndReplacement otherRouter = (SocialAndReplacement) otherHost.getRouter();
    ...
    protected boolean makeRoomForMessage(int size) {
        ...
        while (freeBuffer < size) {
            ...
            for (Connection con : getConnections()) {
                ...
                SocialAndReplacement othRouter = (SocialAndReplacement) other.getRouter();
    ...
    protected Message getNextMessageToRemove(boolean excludeMsgBeingSent) {
        ...
        Collections.sort(validMessages,
                new SocialAndReplacement.MaxPropComparator(this.calcThreshold()));
    ...
    private ArrayList<Tuple<Message, Connection>> socialTheorySort(List<Tuple<Message, Connection>> messages) {
        ...
        for (Tuple<Message, Connection> tmp : messages) {
            ...
            //}
            double wt = ((SocialAndReplacement) dest.getRouter()).getCongestionLevel();
            if (toSend != null) {
