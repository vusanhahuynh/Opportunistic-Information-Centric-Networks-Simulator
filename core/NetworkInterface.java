...
abstract public class NetworkInterface implements ModuleCommunicationListener {
 ...
 /* no battery -> inactive */
    ...
    /*protected boolean isWithinRange(NetworkInterface anotherInterface) {
            System.out.println("myRange" + getTransmitRange());
            System.out.println("yourRange" + anotherInterface.getTransmitRange());
    ...
    // Modified CODE FROM VU SAN HA HUYNH
    protected boolean isWithinRange(NetworkInterface anotherInterface) {
         /*This is modified code commented: double myRange = getTransmitRange();
		...
		return this.host.getLocation().distance(
				anotherInterface.getHost().getLocation()) <= largerRange; */
        //System.out.println("myRange" + getTransmitRange());
        //System.out.println("yourRange" + anotherInterface.getTransmitRange());
        double smallerRange = anotherInterface.getTransmitRange();
        double myRange = getTransmitRange();
